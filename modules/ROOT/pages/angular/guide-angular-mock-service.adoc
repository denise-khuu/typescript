...
image::architecture.png["Service Architecture", width=600 link="images/architecture.png"]
...
image::data-box.jpg["Data Box", width=600 link="images/data-box.jpg"]
...
.Project structure.
image::project-structure.png["Project Structure", width=auto link="images/data-box.png"]
