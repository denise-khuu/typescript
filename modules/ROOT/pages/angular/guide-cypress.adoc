...
image::cypress/contextImg.jpg[]


For more info check link:https://docs.cypress.io/guides/core-concepts/writing-and-organizing-tests#Folder-Structure[Cypress documentation]
